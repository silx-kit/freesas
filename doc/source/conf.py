...
project = u'FreeSAS'
import freesas
year = freesas.date.split("/")[-1]
copyright = u'2015-%s, ESRF' % year
...
version = freesas.strictversion
# The full version, including alpha/beta/rc tags.
release = freesas.version
...
man_pages = [
    ('FreeSAS', 'freesas', u'FreeSAS Documentation',
     [u'Guillaume Bonamis'], 1)
]
...
texinfo_documents = [
  ('FreeSAS', 'FreeSAS', u'FreeSAS Documentation',
   u'Guillaume Bonamis', 'FreeSAS', 'One line description of project.',
   'Miscellaneous'),
]
